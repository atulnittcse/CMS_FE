...
class WriteTodayRatingFragment : Fragment(R.layout.fragment_home) {
    ...
    private fun setUI() {
        ...
        taskAdapter.setOnItemClickListenerForCleanData {
            ...
            Navigation.findNavController(requireActivity(),R.id.nav_host_fragment_content_main).navigate(R.id.action_writeTodayRatingFragment_to_submitFragment)
        }
